...
(function ($) {
    ...
    $(document).ready(function(){
        ...
        $('.post-content .kg-gallery-card').each(function(){
            var elem = $(this);
			elem.find('img').wrap(function() {
				return '<a href="'+$(this).attr('src')+'" class="hover-effect" rel="gallery"></a>';
			});
        });
        $('.post-content .kg-gallery-card a').fancybox({
            type: 'image',
            closeBtn: false,
            loop: false,
            helpers: {
...
/*		var mainImage = null;
		...
		$('div#gallery a:nth-of-type(3n)').addClass('ep-last');
